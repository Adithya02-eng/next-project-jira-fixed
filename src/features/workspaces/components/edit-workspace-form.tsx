...
export const EditWorkspaceForm = ({onCancel,intialValues}:EditWorkspaceProps)=>{
    const {
    ...
    const {
        ...
        isPending: isResettingInvideCode
    } = useResetInviteLink()
    ...
    const [ResetDialog,confirmReset] = useConfirm(
        "Reset Invite Link",
        "This Action will Invalidate the Current Link",
        "destructive"
    )
         ...
         <Card className="w-full h-full border-none shadow-none">
            <CardContent className="p-7">
                <div className="flex flex-col">
                    ...
                    variant={"destructive"}
                    type="button"
                    disabled={isPending || isResettingInvideCode}
        ...
        <Card className="w-full h-full border-none shadow-none">
            <CardContent className="p-7">
                <div className="flex flex-col">
                    ...
                    <p className="text-sm text-muted-foreground">
                       Deleting a workspace is Irreversible and remove all Associated 
                    </p>
                    <DottedSeparator className="py-7"/>
                    <Button
                    className="mt-6 w-fit ml-auto"
